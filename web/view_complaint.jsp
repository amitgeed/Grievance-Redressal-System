...
<html>
    <head>
        ...
        <script>
            function validate(){
                document.getElementById('dError').innerHTML = "Heoolloo";
            }
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p id="cstatus"><b>Status</b> : <%=c.getStatus() %></p>
                            <p id="cdate"><b>Complaint Date </b>: <%=c.getComplaintDate() %></p>
                            <p><b>Solve Date</b> : 
                            <%
